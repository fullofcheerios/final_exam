...
class AdvisorsTest < ApplicationSystemTestCase
  ...
  test "creating a Advisor" do
    ...
    fill_in "Advisorid", with: @advisor.advisorid
    fill_in "Email", with: @advisor.email
    fill_in "Firstname", with: @advisor.firstname
    fill_in "Lastname", with: @advisor.lastname
    fill_in "Student", with: @advisor.student_id
